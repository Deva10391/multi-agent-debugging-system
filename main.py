...
from config import REPO_PATH, FILE_PATH, LLM_RETRY_ATTEMPTS,MAX_DEBUG_ATTEMPTS
...
def main():
    ...
    final_state = app.invoke(initial_states, config={"recursion_limit": 3 * MAX_DEBUG_ATTEMPTS * LLM_RETRY_ATTEMPTS})
